...
def plot_figure(timestamp_list ,bot, chat_id, temperature_list, humidity_list, co2_list, tvoc_list, seconds_since_start_list, temp_min, temp_max, humidity_min, humidity_max, co2_min, co2_max, tvoc_min, tvoc_max, humidity_target, temp_target):
        ...
        tempplot.axhline(y=temp_min, color='red', linewidth=1.5)
        tempplot.axhline(y=temp_target, color='green', linewidth=1.5)
        tempplot.axhline(y=temp_max, color='red', linewidth=1.5)
        humidplot.axhline(y=humidity_min, color='red', linewidth=1.5)
        humidplot.axhline(y=humidity_max, color='red', linewidth=1.5)
        humidplot.axhline(y=humidity_target, color='green', linewidth=1.5)
        co2plot.axhline(y=co2_min, color='red', linewidth=1.5)
        co2plot.axhline(y=co2_max, color='red', linewidth=1.5)
        tvocplot.axhline(y=tvoc_min, color='red', linewidth=1.5)
        tvocplot.axhline(y=tvoc_max, color='red', linewidth=1.5)
